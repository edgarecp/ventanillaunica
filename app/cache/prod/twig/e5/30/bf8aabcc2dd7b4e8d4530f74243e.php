...
";
    ...
    <fieldset>
        ...
        <center><h1>";
        // line 42
        echo twig_escape_filter($this->env, (isset($context["estSisDes"]) ? $context["estSisDes"] : null), "html", null, true);
        echo "</h1></center>
        <br />
    </fieldset>
    <br /><br />
    <fieldset>
        ...
        echo "</td></tr>
            ";
        // line 50
        if (((isset($context["modulo"]) ? $context["modulo"] : null) == "")) {
            // line 51
            echo "            <tr><td>Perfil</td><td>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user"), "perfil"), "html", null, true);
            echo "</td></tr>
            ";
        }
        // line 53
        echo "            <tr><td>Ingreso</td><td>";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["accAct"]) ? $context["accAct"] : null), "ingresoEl"), "d/m/Y h:i:s"), "html", null, true);
        echo "</td></tr>
            <tr><td>Maquina</td><td>";
        // line 54
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accAct"]) ? $context["accAct"] : null), "maquina"), "html", null, true);
        echo "</td></tr>
        </table> 
        <br />        
    </fieldset>
    ...
    ";
        // line 59
        if (((isset($context["accAnt"]) ? $context["accAnt"] : null) == null)) {
            echo "    
    ";
        } else {
            // line 61
        ...
        <table class=\"index\">
            ...
            // line 65
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["accAnt"]) ? $context["accAnt"] : null), "ingresoEl"), "d/m/Y h:i:s"), "html", null, true);
            echo "</td></tr>
            <tr><td>Salida</td><td>";
            // line 66
            if ($this->getAttribute((isset($context["accAnt"]) ? $context["accAnt"] : null), "salidaEl")) {
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["accAnt"]) ? $context["accAnt"] : null), "salidaEl"), "d/m/Y h:i:s"), "html", null, true);
            }
            echo "</td></tr>
            <tr><td>Maquina</td><td>";
            // line 67
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accAnt"]) ? $context["accAnt"] : null), "maquina"), "html", null, true);
            echo "</td></tr>
        </table>
        <br /><br />
    </fieldset>
